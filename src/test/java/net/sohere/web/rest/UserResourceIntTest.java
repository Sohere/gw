package net.sohere.web.rest;

import net.sohere.GwApp;
import net.sohere.domain.Authority;
import net.sohere.domain.User;
import net.sohere.repository.UserRepository;
import net.sohere.security.AuthoritiesConstants;
import net.sohere.service.MailService;
import net.sohere.service.UserService;
import net.sohere.service.dto.UserDTO;
import net.sohere.service.mapper.UserMapper;
import net.sohere.web.rest.errors.ExceptionTranslator;
import net.sohere.web.rest.vm.ManagedUserVM;
